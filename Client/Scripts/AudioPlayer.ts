...
export class AudioPlayer {
    ...
    private dom_logoImage;
    private dom_player: HTMLElement;
    private dom_player_songTitle: HTMLElement;
    private dom_player_currentanddurationContainer: HTMLElement;
    private dom_player_controllers: HTMLElement;
    private dom_previous;
    private dom_backward;
    private dom_play;
    private dom_forward;
    private dom_next;
