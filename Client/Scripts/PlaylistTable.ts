...
export class PlaylistTable {
    ...
    private dom_AddNewSongHeader: HTMLDivElement;
    private dom_AddNewSongDialogButton: HTMLInputElement;
    private dom_AddNewSongTitle: HTMLInputElement;
    private dom_AddNewSongArtist: HTMLInputElement;
    private dom_InputToken: HTMLInputElement;
    private dom_AddNewSongSubmit: HTMLButtonElement;
    private dom_AddNewSongProgress: HTMLDivElement;
    private dom_AddNewSongProgressBar: HTMLDivElement;
    ...
    private async fetchNewCollab(index) {
            try {
                const response = await fetch(this.API_URL + '/collabs/' + this.PlaylistID, {
                    body: JSON.stringify({
                ...
                console.log("Error sharing Playlist with mate ")
            }
        }
